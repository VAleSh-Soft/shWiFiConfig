...
```
установка файла для сохранения настроек WiFi; по умолчанию настройки сохраняются в файле **/wifi.json**; второй метод - соовтетственно, получение имени файла с настройками.
