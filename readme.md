...
```
включение/отключение шифрования паролей при сохранении; параметр `_crypt_key` позволяет задать ключ для шифрования паролей; если оставить его пустым, будет использовать ключ по умолчанию (64 бит);
