...
- [shWiFiConfig - библиотека для настройки параметров WiFi-подключения для esp8266 и esp32](#shwificonfig---библиотека-для-настройки-параметров-wifi-подключения-для-esp8266-и-esp32)
